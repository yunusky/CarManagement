...
{
    public class _DefaultBlogDetailSideBarRecentBlogComponentPartial : ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public _DefaultBlogDetailSideBarRecentBlogComponentPartial(IHttpClientFactory httpClientFactory)
        {
